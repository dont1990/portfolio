        ...
        <div className="section-container relative z-10">
          ...
          >
            ...
            >
              ...
              creating engaging digital experiences that users love.
            </motion.p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <p className="text-muted-foreground mb-6 leading-relaxed">
                ...
                websites work. Today, I specialize in React, Next.js, and modern
                frontend technologies to build scalable, performant
                applications.
              </p>
              <p className="text-muted-foreground mb-6 leading-relaxed">
                I believe in writing clean, maintainable code and creating
                intuitive user interfaces that solve real problems. When I'm not
